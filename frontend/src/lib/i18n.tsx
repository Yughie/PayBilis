...
type Translation = {
  ...
  form: {
    ...
    frequencyOptions: Array<{
      value: "One-time" | "Monthly Subscription";
      label: string;
    }>;
    review: {
      title: string;
...
const translations: Record<Language, Translation> = {
  fil: {
    header: {
      subtitle: "Pagbabayad ng bill sa door-to-door",
    ...
    hero: {
      badge: "Maaasahang pag-aayos ng bayarin",
      title:
        "Door-to-door na pagbabayad ng bayarin na may propesyonal at mapagkakatiwalaang karanasan.",
      description:
        "Pinapadali ng PayBilis ang pag-sign up ng serbisyo para sa mga tahanan at maliliit na negosyo gamit ang mabilis, beripikado, at madaling repasuhing proseso.",
      setupSubscription: "I-setup ang subscription",
      exploreHowItWorks: "Tingnan kung paano ito gumagana",
      verified: "Beripikado",
      verifiedDescription: "Beripikasyon ng address ng bahay",
      fast: "Mabilis",
      fastDescription: "Hakbang-hakbang na beripikasyon",
      secure: "Ligtas",
      secureDescription: "Propesyonal na proseso ng pagsusuri",
      dashboardTitle: "Mas mahinahon at mas kapani-paniwalang onboarding view.",
      dashboardSubtitle: "Dashboard ng PayBilis",
      verifiedFlow: "Beripikadong daloy",
      verifiedFlowDescription:
        "Nasa iisang lugar ang detalye ng tahanan at mga biller.",
      flexibleSchedule: "Nababagong iskedyul",
      flexibleScheduleDescription:
        "Magkakaibang petsa ng koleksyon para sa bawat biller.",
      fastSetup: "Mabilis na pag-setup",
      trustSignal: "Hudyat ng tiwala",
    ...
    howItWorks: {
      ...
      description:
        "Nakaayos ang proseso sa malinaw na mga checkpoint ng onboarding para makapag-verify ng pagkakakilanlan, makapag-link ng account, at makapag-schedule ng koleksyon nang walang kalituhan.",
      cards: [
        {
          title: "1. Ibahagi ang mga detalye mo",
          description:
            "Ilagay ang iyong pangalan, contact number, at beripikadong address ng bahay para masimulan ang subscription.",
        },
        {
          title: "2. Idagdag ang impormasyon ng bill",
          description:
            "Ibigay ang pangalan ng biller, account number, at account name para sa tumpak na onboarding.",
        },
        {
    ...
    form: {
      ...
      title:
        "Isang gabay na onboarding flow para sa pinagkakatiwalaang paulit-ulit na bayad.",
      ...
      personal: {
        ...
        houseAddressHint:
          "Gamitin ang eksaktong address kung saan mangyayari ang koleksyon ng bill.",
      ...
      billers: {
        title: "Mga biller",
        description:
          "Magdagdag ng kuryente, tubig, internet, o anumang biller.",
        remove: "Tanggalin",
        ...
        accountNumberError: "Kailangan ang numero ng account",
        ...
        collectionDateHint:
          "Piliin ang petsa ng koleksyon para sa biller na ito.",
      ...
      review: {
        title: "Repasuhin ang subscription mo",
        description:
          "Na-validate na ang mga inilagay mo at handa nang isumite.",
        details: [
          "Buong Pangalan",
          "Kontak",
          "Address ng bahay",
      ...
      submittedDescription:
        "Natanggap na ng PayBilis ang mga detalye ng onboarding at maaari nang magpatuloy sa beripikasyon.",
      trustedControls: "Mga pinagkakatiwalaang kontrol",
      trustedControlItems: [
        "Kinakailangan ang beripikadong address ng bahay bago ma-activate.",
        "Na-optimize para sa mabilis na paulit-ulit na onboarding.",
        "Ligtas at propesyonal na daloy ng koleksyon ng bill.",
      ],
    },
    summary: {
      ...
      serviceStatusDescription:
        "Kukumpirmahin ng PayBilis team ang beripikadong address at mga iskedyul ng koleksyon kada biller.",
    },
    footer: {
      copyright:
        "© 2026 PayBilis. Maaasahang door-to-door na subscription sa pagbabayad ng bill.",
      tagline:
        "Karanasang nakasentro sa tiwala gamit ang asul at luntiang tema para sa mga gumagamit sa bahay at negosyo.",
      creatorTitle: "Nilikha ni Yughie Perez",
      creatorDescription:
        "Si Yughie Perez ay isang Data at AI Engineer na nagsimula ng PayBilis para itulak ang inobasyon, makatulong laban sa tumataas na gastos sa gasolina, at gawing mas maginhawa ang pagbabayad ng bill para sa mga tao.",
    },
  },
  en: {
    header: {
    ...
    hero: {
      ...
      title:
        "Door-to-door bill payments with a professional and trustworthy experience.",
      description:
        "PayBilis simplifies service enrollment for households and small businesses with a fast, verified, and easy-to-review flow.",
      setupSubscription: "Setup Subscription",
    ...
    howItWorks: {
      ...
      description:
        "The flow is structured around clear onboarding checkpoints so users can verify identity, connect an account, and schedule collections without confusion.",
      cards: [
        {
          title: "1. Share your details",
          description:
            "Enter your name, contact number, and verified house address to start the subscription.",
        },
        {
          title: "2. Add bill information",
          description:
            "Provide the biller name, account number, and account name for accurate onboarding.",
        },
        {
    ...
    form: {
      ...
      personal: {
        ...
        houseAddressHint:
          "Use the exact address where the bill collection will happen.",
      ...
      review: {
        ...
        description: "Your input is validated and ready for submission.",
        details: ["Full Name", "Contact", "Address", "Billers", "Frequency"],
      },
      pending: "Pending",
      back: "Back",
      continue: "Continue",
      ...
      submittedDescription:
        "PayBilis has received the onboarding details and can proceed with verification.",
      trustedControls: "Trusted controls",
      trustedControlItems: [
        "Verified household address required before activation.",
        "Optimized for fast recurring onboarding.",
        "Secure and professional bill collection flow.",
      ],
    },
    summary: {
      ...
      serviceStatusDescription:
        "Verified address and per-biller collection schedules will be confirmed by the PayBilis team.",
    },
    footer: {
      copyright:
        "© 2026 PayBilis. Reliable door-to-door bill payment subscriptions.",
      tagline:
        "Deep blue and green trust-led experience for residential and business users.",
      creatorTitle: "Created by Yughie Perez",
      creatorDescription:
        "Yughie Perez is a Data and AI Engineer who started PayBilis to drive innovation, help counter rising fuel costs, and make bill payments more convenient for people.",
    },
  },
};
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<LanguageContextValue>(
    () => ({
      ...
      setLanguage,
      toggleLanguage: () =>
        setLanguage((current) => (current === "fil" ? "en" : "fil")),
...
export function getFrequencyLabel(language: Language, value: string) {
  const labelMap = translations[language].form.frequencyOptions.find(
